...
#include "imgui.h"
#include "Panels/Inspector/TextureSlotManager.h"
...
namespace hellfire::editor::ui {
     ...
     *  Example Postion will be returned as ##Position
     */
    inline std::string generate_ui_id(const std::string &label) {
        return "##" + label;
    }

    /**
     * @brief Generic property drawer with minimal overhead
     */
    template<typename T, typename DrawFunc>
    bool Property(const std::string &label, T *value, DrawFunc draw_func) {
        ImGui::Text("%s", label.c_str());
        ImGui::SameLine(180);
        return draw_func(generate_ui_id(label).c_str(), value);
    }

    /**
     *  @brief Draws a float input field with drag functionality
     * @param label Display label for the property
     * @param value Pointer to the float value to modify
     * @param speed Drag step size (default: 1.0f)
     * @param min Minimum allowed value (default: 0.0f)
    ...
    /**
     * @brief Draws a 2D vector input field with drag functionality
     * @param label Display label for the propert
     * @param value Pointer to the vec2 value to modify
     * @param speed Drag step size (default: 1.0f)
     * @param min Minimum allowed value (default: 0.0f)
     * @param max Maximum allowed value (default: FLT_MAX)
     * @return True if the value was modified
    ...
    /**
     * @brief Draws a 3D vector input field with drag functionality
     * @param label Display label for the propert
     * @param value Pointer to the vec3 value to modify
     * @param speed Drag step size (default: 1.0f)
     * @param min Minimum allowed value (default: 0.0f)
     * @param max Maximum allowed value (default: FLT_MAX)
     * @return True if the value was modified
    ...
    /**
     * @brief Draws a dropdown combo box for integer selection
     * @param label Display label for the property
     * @param labels Null-seperated list of options (e.g., "Option1\0Option2\0Option3\0"
     * @param value Pointer to the selected item index
    ...
    /**
     * @brief Draws an RGB color picker
     * @param label Display label for the property
     * @param value Pointer to the vec3 color value (RGB)
    ...
    /**
     * @brief Draws an RGBA color picker
     * @param label Display label for the property
     * @param value Pointer to the vec4 color value (RGBA)
     * @return True if the color was modified
     */
    ...
    /**
     * @brief Draws a checkbox input field
     * @param label Display label for the property
     * @param value Pointer to the boolean value to modify
     * @return True if the value was toggled
     */
    ...
    /**
     * @brief Draws a complete texture slot widget with enable/disable toggle and file picker
     * @param material Material to modify
     * @param slot Texture slot configuration
     * @return True if any changes were made to the material
     */

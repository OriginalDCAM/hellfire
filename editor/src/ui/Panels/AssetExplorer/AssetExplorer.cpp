...
namespace hellfire::editor {
    ...
    void AssetExplorer::render_asset_tile(const AssetMetadata& asset, const float size, 
        ...
        ImU32 bg_color = is_selected ? IM_COL32(70, 130, 180, 255) 
                             : is_hovered  ? IM_COL32(60, 60, 60, 255)
        ...
        if (ImGui::BeginPopupContextItem(("##" + asset.filepath.string()).c_str())) {
            ...
            if (ImGui::MenuItem("Delete", nullptr, false, false)) { /* disabled */ }
            ImGui::EndPopup();
        }
...
#if WIN32
        ShellExecuteW(NULL, L"open", path.c_str(), NULL, NULL,
                      SW_SHOW);
#endif
    }
} // hellfire
